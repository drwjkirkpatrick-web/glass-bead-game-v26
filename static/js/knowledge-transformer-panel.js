...
(function() {
    ...
    // All 19 knowledge transformers configured for the panel (11 original + 8 Coda).
    // Colors match Config.BEAD_TYPES in config.py.
    KnowledgeTransformerPanel.TRANSFORMERS = [
        // ── Original transformers ──
        { domainA: "Mathematics", domainB: "Music",
          endpoint: "/api/transform/math-music",
          catalogEndpoint: "/api/transform/math-music/catalog",
          defaultConcept: "Cyclic group Z_12",
          defaultConceptB: "Circle of fifths",
          defaultProperty: "cyclic group generated by coprime element",
          colorA: "#ff00ff", colorB: "#00e5ff" },
